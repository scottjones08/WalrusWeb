...
const industries = [
  ...
  },
  {
    ...
    detail: "Secure processing with a tone that builds patient trust.",
  },
  {
    title: "Retail & boutique",
    detail: "Unified in-store and online experiences with sleek checkout flows.",
  },
  {
    title: "Professional services",
    detail: "Invoices, retainers, and recurring billing that look polished.",
  },
];
...
export function RatesPage() {
  return (
    <div className="bg-slate-950 text-white">
      <section className="mx-auto w-full max-w-6xl px-4 pb-12 pt-20 sm:px-6">
        <motion.div
          initial="hidden"
          whileInView="show"
        ...
        >
          ...
          <h1 className="text-4xl font-semibold sm:text-5xl">
            Rates built around your business — never a template.
          </h1>
      ...
      <section className="bg-slate-900 px-4 py-16 sm:px-6">
        <div className="mx-auto w-full max-w-6xl space-y-8">
          ...
          <motion.div
            ...
            variants={fadeUp}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="flex flex-wrap items-center gap-4 rounded-2xl border border-white/10 bg-white/5 p-6"
          >
